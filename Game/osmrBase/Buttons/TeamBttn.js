...
function OB_TeamBttn(pHeight, pWidth, alert) {

  var btn = PIXI.Texture.from(osmrBaseAssets.bttn_pinkCir)
  var ico = PIXI.Texture.from(osmrBaseAssets.ico_team)
